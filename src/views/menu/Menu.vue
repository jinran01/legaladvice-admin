<template>
  <div class="main">
    <form class="main_form" @submit.native.prevent>
      <!--      <el-date-picker-->
    ...
    >
      ...
      <el-table-column prop="icon" label="图标" width="100" align="center">
        <template #default="scope">
          <el-icon>
            <i class="fas" :class="scope.row.icon"></i>
          </el-icon>
        </template>
      </el-table-column >
      ...
      <el-form :model="form" >
        ...
        <el-form-item label="菜单图标" >
          <el-dropdown max-height="140" @visible-change="getIcons">
            ...
            <template #dropdown>
              <el-dropdown-menu>
                <el-dropdown-item v-for="(item) in icons" @click="form.icon = item.class">
                  <template #default>
                    <el-icon>
...
import {glyphs} from "@/common/icons/icon";
