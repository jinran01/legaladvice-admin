      ...
      <el-tab-pane name="first">
        ...
        <div class="web_info">
          ...
          >
            ...
            <!--              </el-upload>-->
            <!--              &lt;!&ndash;              <el-avatar shape="circle" :size="100" fit="fit" :src="userInfo.avatar" />&ndash;&gt;-->
            <!--            </el-form-item>-->
      ...
      <el-tab-pane name="second">
        ...
        >
          <el-form-item label="用户头像">
            ...
            >
              <el-avatar shape="circle" :size="100" fit="fit" :src="webInfoConfig.userAvatar"/>
            </el-upload>
          </el-form-item>
          <el-form-item label="游客头像">
            ...
            >
              <el-avatar shape="circle" :size="100" fit="fit" :src="webInfoConfig.touristAvatar"/>
            </el-upload>
          </el-form-item>
          ...
          <el-form-item label="Websocket" v-if="webInfoConfig.isChatRoom">
            <el-input v-model="webInfoConfig.websocketUrl"></el-input>
          </el-form-item>
...
export default {
  ...
  setup() {
    ...
    let action = ref("https://legaladvice.oss-cn-beijing.aliyuncs.com/");
    ...
    const before_upload = (file) => {
      ...
      return new Promise((resolve, reject) => {
        getPolicy({path:"default"}).then(res => {
